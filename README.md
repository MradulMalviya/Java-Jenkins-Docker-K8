...
Now Goto Loadbalancer and check whether the service comes Inservice or not, If it comes Inservice copy DNS Name of the Loadbalancer and Give in WebUI
...
Now we can clean by using the following:
